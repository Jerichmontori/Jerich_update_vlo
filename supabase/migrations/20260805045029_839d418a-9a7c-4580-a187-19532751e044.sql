...
BEGIN
  ...
  ELSIF clear_text_true THEN
    -- Clear Text = Ya → seluruh 5 kriteria tersisa (Vokal/Interpretasi, Penghayatan,
    -- Intonasi/Artikulasi, Penampilan, Catatan Juri) menentukan pergerakan nilai
    -- dari nilai VAR/tidak clear menuju BATAS ATAS. Semua sempurna → batas atas.
