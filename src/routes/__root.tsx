...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aplikasi penilaian dan pemeringkatan lomba baca Mazmur — kelola peserta, juri, kriteria, dan lihat ranking otomatis." },
      { property: "og:title", content: "Sistem Penjurian Baca Mazmur" },
      { property: "og:description", content: "Aplikasi penilaian dan pemeringkatan lomba baca Mazmur." },
